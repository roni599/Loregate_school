...
import ManagingList from './ManagingList.vue';
export default {
    name: "Managing",
    setup() {
        ...
        const componentLoad = () => {
            currentComponent.value = markRaw(ManagingList)
        }
        const anotherLoad = () => {
        ...
        const submitForm = async () => {
            ...
            try {
                const response = await axios.post('/api/academy/managingcummunity', formData, {
                    headers: {
